            ...
            <div className="p-5">
              ...
              <div className="mt-5 flex justify-end gap-3">
                <button
                  ...
                  className="flex-1 rounded-lg border border-gray-300 bg-white px-4 py-2 text-center text-sm font-medium text-gray-700 shadow-sm transition-all hover:bg-gray-100"
                >
                  Cancel
                </button>
                <button
                  onClick={() => deleteCategory(categoryToDelete._id)}
                  className="flex-1 rounded-lg border border-red-500 bg-red-500 px-4 py-2 text-center text-sm font-medium text-white shadow-sm transition-all hover:border-red-700 hover:bg-red-700"
                >
                  Delete
                </button>
              </div>
          ...
          <tbody>
            {categories.map((category, index) => (
              <tr key={category._id} className="bg-white-50">
                ...
                <td style={{ fontSize: 21, fontWeight: "500" }} className="px-4 py-2 ">
                  {category.name}
                </td>
